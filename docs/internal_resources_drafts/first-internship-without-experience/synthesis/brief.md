...
[GEM] **Design the résumé for non-technical pattern-matching in under a minute** — Lead with evidence of technical ability (project details, OSS, hackathons, clubs) and remove low-signal clutter; otherwise you risk being sorted into “only classroom experience.” (CodeDay)  

[GEM] **Start the internship clock earlier than feels reasonable** — For summer roles, practitioner guidance often points to **starting the prior summer (~July)** and treating fall as peak season; waiting until “this semester feels busy” misses quota fills. (Levels.fyi)  

[GEM] **Use identity-aligned accelerators as structured substitutes for “network + coaching”** — ColorStack (community + programming), Code2040 Fellows (if you meet coding + internship track requirements), MLT Ascend (if freshman + eligibility fits), SEO Tech Developer (typically sophomore pipeline), AFROTECH/AFROTECH U (concentrated recruiting exposure). Combine **one community anchor** with **one artifact** (shipped project).  

[GEM] **If you have “no experience,” your project is your experience** — One strong project with measurable outcome, stack, and link beats a long “skills” list; student write-ups consistently treat this as the main interview foot-in-door when job history is empty. (CodeDay + student Medium/Dev.to convergence)  

[GEM] **Choose internship vs externship on purpose** — Hands-on internship for building hireable skills; externship/shadowing for exploration when you’re still deciding. Stops wasted cycles on the wrong opportunity type. (AfroTech)  

**Supporting** — Apply when you meet a majority of listed requirements; don’t treat every “preferred” line as a hard stop. (Common across Extern/WayUp-style guides.)  

**Supporting** — Seasonal application windows (fall/spring/summer cycles) matter; smaller companies may hire closer to start date. (DEV strategic guide + Levels.fyi nuance on startups.)  
...
Section 1: **How internships get decided before you feel ready** — Recruiter pattern-matching + calendar (Levels.fyi/CodeDay); what “no experience” actually means in CS intern hiring.  

Section 2: **Your first proof stack (2–4 weeks, not a hero arc)** — One shipped project, README quality, GitHub hygiene; translating coursework/clubs into bullets; what to delete from a template résumé.  

Section 3: **Where the first yes comes from** — Big company vs startup vs programs (CodeDay Labs, Outreachy/GSoC-style); **intern vs extern** choice (AfroTech).  

Section 4: **Community and accelerators that fit Black/Latinx CS students** — ColorStack, AFROTECH U, Code2040, MLT Ascend, SEO Tech Developer — framed as **eligibility + timing + what to do this month if you’re waitlisted or not eligible yet**.  

The mistake: **Waiting for permission to be “experienced” instead of publishing evidence and joining one structured community pipeline early enough.**  

Close: **This-week sprint** — (1) audit résumé against CodeDay’s “irrelevant vs missing” lists, (2) add or upgrade one project with metrics + link, (3) apply to five roles **or** reserve five outreach slots to alumni/engineers, (4) calendar the next program deadline (Ascend/Fellows/SEO) if eligible.  

"WHAT YOU'LL LEAVE WITH" DRAFT  
• A **timeboxed plan** mapped to real recruiting seasons and Northeastern-style term pressure (weekly tasks, not vibes).  
• A **résumé editing checklist** grounded in how non-technical screeners skim CS interns.  
• A **program map** (ColorStack, AfroTech, Code2040, MLT, SEO Tech Developer, structured labs) with **eligibility realities** and next actions.  
