---
slug: outreach-templates-that-work
title: Cold Outreach Templates for Students in Tech
category: community
...
**[Your name]**  
**[.edu or clean email] | [GitHub or portfolio link]**

**C) Follow-up #1 (add one new detail; do not resend the same block)**  
...
**D) After a career fair, summit, or info session**  
...
The failure mode is the same template blasted wide with only the name swapped. It reads like spam, burns time, and pushes your voice toward generic. Send three messages in the next twenty-four hours. Aim each at a high-fit person with one line you could not have written without opening their profile or product page, and close with the same small ask: fifteen minutes, or one pointed question they can answer in email.
