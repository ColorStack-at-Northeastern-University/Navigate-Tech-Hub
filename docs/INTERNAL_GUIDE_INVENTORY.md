...
| ----------------------------------- | --------------------------------------------------------------- | -------------- | -------------- | ------------------------------------------------------------------------------------------------------- | ---------- | ---------- | ----- |
| application-to-offer-timeline       | The Tech Internship Timeline: What Happens and When             | interview-prep | first-year     | Understand the full timeline from application to offer and what typically happens at each step.         | 5          | medium     | 1     |
| interview-process-map               | Interview Process Map: What Interviewers Evaluate at Each Stage | interview-prep | first-year     | Know what recruiters and interviewers are evaluating at each stage and how to prepare without guessing. | 5          | medium     | 1     |
| first-internship-without-experience | How to Get Your First Internship When You Have No Experience    | interview-prep | first-year     | Follow a practical plan to pursue a first internship when résumé lines are still thin.                  | 5          | medium     | 1     |
...
| negotiating-your-first-offer        | How to Negotiate Your First Internship Offer                    | interview-prep | underclassmen  | Negotiate a first internship or early offer without damaging relationships.                             | 5          | medium     | 2     |
| internship-to-return-offer          | How to Convert Your Internship Into a Return Offer              | interview-prep | underclassmen  | Track the behaviors and milestones that improve odds of a return offer.                                 | 5          | medium     | 2     |
...
| open-source-as-experience           | Using Open Source Contributions as Portfolio Experience         | projects       | first-year     | Present open source work as verifiable portfolio signal alongside class projects.                       | 5          | medium     | 2     |
...
| linkedin-profile-system             | LinkedIn Profile System for CS Students                         | community      | first-year     | Maintain a LinkedIn profile and activity pattern tuned for recruiting visibility.                       | 5          | medium     | 1     |
| colorstack-nsbe-afrotech-guide      | Making the Most of Black and Latinx Tech Communities            | community      | first-year     | Get concrete value from Black and Latinx tech communities (programs, conferences, chapters).            | 6          | high       | 1     |
...
## 6) Manual review and split notes

- `**cs-course-planning-neu`:** Not synthesis-only from general web search. Requires NEU-specific sourcing (for example r/NEU patterns, RateMyProfessors patterns where appropriate, Khoury / academic advising public materials). Treat article-synthesizer output as blocked until manual sources are gathered; flag for project lead before publishing.
- `**interview-process-map` split:** Timeline content lives under `application-to-offer-timeline`; this slug keeps the “what interviewers evaluate at each stage” guide.
- **`selecting-electives-intentionally`:** Intended as a **synthesis-only** guide (no personal narrative). Final draft must use **third person / impersonal voice only** (no first-person). Keep course examples **school-agnostic** or explicitly fact-checked — offerings and rules differ by institution.
