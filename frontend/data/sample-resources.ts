...
export const SAMPLE_EXTERNAL_RESOURCES: ExternalResource[] = [
    ...
    },
    {
        ...
        description: 'Free, project-based AI engineering program for underrepresented students in CS.',
        url: 'https://www.codepath.org',
        category: 'programs',
        directoryTier: 'recurring-program',
        resourceType: 'learning-platform',
        programType: 'pre-internship',
        seasonalNote: 'Typically opens applications in spring. Visit the program page to see the current cycle status.',
