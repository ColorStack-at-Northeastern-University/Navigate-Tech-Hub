...
export const FAQ_SECTIONS: FaqSection[] = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer:
                    'See the dedicated [Resume](/resume) page for sample resumes, templates, and a path you can follow without internship experience. Trust that you will not regret it.',
        ...
        items: [
            {
                ...
                answer:
                    '**Interview Prep**, **Classes**, **Projects**, **Hackathons**, and **Community** are meant to represent all the different domains a CS student has to manage. The best of the best tend to have excelled at all five! This hub is how you can start. Open [Browse](/browse) to search across all guides or pick a category hub from the menu.',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer:
                    'Use [Pitch a topic](/contributions#propose-guide) on the [Contributions](/contributions) page (GitHub issue with the internal-resource-suggestion label) or email me at [odubiyi.a@northeastern.edu](mailto:odubiyi.a@northeastern.edu) with a working title, audience, and 2–3 outcomes the reader should have after reading.',
