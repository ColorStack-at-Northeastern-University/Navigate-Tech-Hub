            ...
            <main className="mt-16">
                ...
                <div className="container-custom">
                    ...
                    <section className="mb-12">
                        <h2 className="font-display text-3xl font-bold text-brand-dark mb-6">Our Mission</h2>
                    ...
                    {/* Values Section */}
                    <section className="mb-12">
                        <h2 className="font-display text-3xl font-bold text-brand-dark mb-6">Our Values</h2>
                        <div className="bg-white rounded-xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.1)] border-t-[3px] border-neu-red">
                            <div className="grid md:grid-cols-2 gap-8">
                                <div>
                                    <h3 className="text-xl font-bold text-neu-red mb-3">Student-Led</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-neu-red mb-3">Open Source</h3>
                                    <p className="text-gray-700 leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-neu-red mb-3">Inclusive</h3>
                                    <p className="text-gray-700 leading-relaxed">
                    ...
                    <section className="mb-16" id="get-involved">
                        <h2 className="font-display text-3xl font-bold text-brand-dark mb-6">Get Involved</h2>
                        <div className="bg-white rounded-xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.1)] border-t-[3px] border-neu-red">
                            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
