...
export default function ArticlePage({ params }: { params: { category: string; slug: string } }) {
     ...
     */
    const resource = null; // Find resource here
     ...
     */
    const categoryData = null; // Find category here
     ...
     *   .slice(0, 3)
     */
    const relatedResources = []; // Get related resources here
